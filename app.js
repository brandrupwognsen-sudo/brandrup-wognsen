...
{\*\expandedcolortbl;;}
\paperw11900\paperh16840\margl1440\margr1440\vieww12340\viewh14120\viewkind0
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0

\f0\fs24 \cf0 // 1) Paste your published CSV URL here\
...
function renderCards(data) \{\
  ...
  cards.innerHTML = data.map(d => `\
    <div class="card">\
      ...
      <div class="meta">\
        <span class="pill">$\{escapeHtml(d.country || "\'97")\}</span>\
...
function escapeHtml(str) \{\
  return String(str ?? "")\
    ...
    .replaceAll("'", "&#039;");\
\}\
function fmt(n) \{ return n == null ? "\'97" : n.toFixed(1).replace(".", ","); \}\
function fmtInt(n) \{ return n == null ? "\'97" : String(Math.round(n)); \}\
\
function rerender() \{\
